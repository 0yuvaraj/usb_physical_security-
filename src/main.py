...
IMPORTANT: This application relies on Windows Registry modifications (winreg) 
and ctypes.windll. It is strictly designed for Windows operating systems.
"""
...
# [CRITICAL SECURITY FIX]: Removed hardcoded PII. 
# Replace these placeholders with your actual recipient emails before deployment.
...
def configure_email_settings():
    ...
    The recipient emails are configured via the global list at the top of the script.
    """
    global EMAIL_SENDER, EMAIL_PASSWORD
